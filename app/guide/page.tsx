        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="md:w-1/2 flex justify-center">
              {/* ロゴプレースホルダー */}
              <div className="w-64 h-64 bg-indigo-100 rounded-full flex items-center justify-center border-4 border-white shadow-inner">
                <span className="text-6xl font-bold text-indigo-600">OD</span>
              </div>
            </div>
          </div>
        </div>
